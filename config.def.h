...
static const Rule rules[] = {
	...
	{ "Gimp",     NULL,           0,            1,          0,      1,         -1 },
	*/
	{ BROWSER,    NULL,           0,            0,          0,      1,         -1,      0},
	{ TERMINAL,   NULL,           0,            0,          1,      1,         -1,      0},
  { NULL,       "tridactyl",    0,            1,          0,      1,         -1,      0},
	{ NULL,       "sp-calc",      0,            1,          0,      1,         -1,     'c'},
};
...
static const char *calculator[] = { "c", TERMINAL, "-T", "sp-calc", "-e", "bc", "-lq", NULL };
...
static const Key keys[] = {
  ...
  /* Launch applications */
	...
	{ MODKEY,                    XKB_KEY_apostrophe,  togglescratch,  {.v = calculator} },
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_B,           spawn,		      {.v = (const char*[]){ TERMINAL, "-e", "bluetoothctl", NULL } } },
